...
object SparkDirectStreaming {
  ...
  def createStreamingContext():StreamingContext={
    ...
    var kafkaParams=Map[String,String]("bootstrap.servers"-> "192.168.217.11:9092,192.168.217.12:9092,192.168.217.13:9092")//创建一个kafkaParams
    ...
    val zkClient = new ZkClient("192.168.217.11:2181,192.168.217.11:2181,192.168.217.11:2181", 30000, 30000,ZKStringSerializer)
    val zkOffsetPath = "/sparkstreaming/20180131"//zk的路径
